...
/* Event Bindings - hashchange, submit, and click */
	...
	$.mobile._registerInternalEvents = function(){
		...
		// click routing - direct to HTTP or Ajax, accordingly FIND ME i think this is it
		$( document ).bind( "click", function( event ) {
			...
			//if ajax is disabled, exit early FIND ME
			...
			if ( href.search( "#" ) != -1 ) { //if we found a hash in the href
				href = href.replace( /[^#]*#/, "" );
				if ( !href ) {
